...
import { Plus, UserPlus, Trash2, Edit2, ShieldAlert, Check, X, ToggleLeft, ToggleRight, Database, Server, RefreshCw, Copy, Share2, Users, BellRing, MessageSquareCode } from 'lucide-react';
...
export const AdminPanel: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'students' | 'mfa' | 'database'>('students');
                    ...
                    {editStaffObj.role === 'Teacher' ? (
                      ...
                      <div>
                        ...
                        <div className="bg-neutral-950 border-2 border-neutral-850 py-3 px-4 text-xs text-neutral-500 font-extrabold font-mono uppercase tracking-wider">
                          {editStaffObj.role === 'Administrator' ? 'All Areas' : 'Accounting Desk'}
                        </div>
                      </div>
                    )}
                  </div>
