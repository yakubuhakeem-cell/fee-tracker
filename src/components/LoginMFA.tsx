                            ...
                            {users.map((acc) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`p-4 border-2 text-left transition-all relative ${isSelected
                                    ...
                                    >
                                        ...
                                        <p className={`text-[10px] font-mono mt-1 font-bold ${isSelected ? 'text-neutral-900' : 'text-neutral-500'
                                            }`}>
                                            {acc.role} {acc.assignedClass ? `• ${acc.assignedClass}` : ''}
                                        </p>
                                        {acc.mfaEnabled && (
                                            <span className={`inline-block text-[8px] font-black mt-2 px-1.5 py-0.5 uppercase tracking-widest ${isSelected
